...
import tech.carcadex.kotlinbukkitkit.commands.CommandParams
import tech.carcadex.kotlinbukkitkit.commands.Parser
import tech.carcadex.kotlinbukkitkit.commands.annotations.Command
import tech.carcadex.kotlinbukkitkit.commands.annotations.Default
...
object SubCommandsService {
    ...
    fun registerRootCommand(command: Any): Pair<String, List<SubCommand>> {
        ...
        for(func in clazz.functions) {
            if(func.hasAnnotation<tech.carcadex.kotlinbukkitkit.commands.annotations.SubCommand>()) {
    ...
    private fun parseSubCommand(func: KFunction<*>, rootCommand: Any): SubCommand {
        ...
        val name = if(func.hasAnnotation<Default>()) "default" else func.findAnnotations(tech.carcadex.kotlinbukkitkit.commands.annotations.SubCommand::class).first().name
