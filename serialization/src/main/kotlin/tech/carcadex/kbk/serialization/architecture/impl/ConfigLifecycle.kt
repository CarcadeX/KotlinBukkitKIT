...
package tech.carcadex.kbk.serialization.architecture.impl

import tech.carcadex.kbk.architecture.KotlinPlugin
import tech.carcadex.kbk.architecture.extensions.WithPlugin
import tech.carcadex.kbk.architecture.lifecycle.LifecycleEvent
import tech.carcadex.kbk.architecture.lifecycle.LifecycleListener
import tech.carcadex.kbk.architecture.lifecycle.PluginLifecycleListener
import tech.carcadex.kbk.architecture.lifecycle.getOrInsertGenericLifecycle
import tech.carcadex.kbk.serialization.SerializationConfig
import tech.carcadex.kbk.serialization.architecture.getConfig
...
internal class ConfigLifecycle(
    ...
    internal val serializationConfigurations = hashMapOf<String, tech.carcadex.kbk.serialization.SerializationConfig<Any>>()

    internal val onEnableLoadSerializationConfigurations = mutableListOf<tech.carcadex.kbk.serialization.SerializationConfig<*>>()
    internal val onDisableSaveSerializationConfigurations = mutableListOf<tech.carcadex.kbk.serialization.SerializationConfig<*>>()
...
internal fun KotlinPlugin.registerConfiguration(
    config: tech.carcadex.kbk.serialization.SerializationConfig<Any>,
...
public class ConfigDelegate<T, R>(
    ...
    private var configCache: tech.carcadex.kbk.serialization.SerializationConfig<*>? = null
